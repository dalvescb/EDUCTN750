...
* Week 12
** Individual reflection on EDU 750/1

   1. What core values have you recognized in yourself as an educator?
      - I value finding enjoyment in the act of education (teaching and learning).
        Not necessarily with some end goal but valuing the process itself as an experience

   2. What have you learned through this course that you would like to apply to
      your current or near future teaching?
      - Universal Design for learning is a big one, overall I want to be more
        flexible and accomadating with my students going forward. Also although
        I've always believed in a certain amount of active learning I definitely
        have learned more defined strategies for doing so
   3. How can you see yourself applying what you have learned through this
      course to your current career ambitions?
      - I definitely see myself using the teaching portfolio I've developed to
        apply for jobs and the knowledge about how to build a teaching portfolio
        to update it as I continue my career. I also think I'll apply what I've
        learned to improve my presentation skills in general whether I'm
        teaching or presenting at a conference
